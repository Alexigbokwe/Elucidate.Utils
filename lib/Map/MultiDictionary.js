...
exports.MultiDictionary = void 0;
const util = __importStar(require("../Collection/Utils"));
const Dictionary_1 = require("./Dictionary");
const arrays = __importStar(require("../Collection/Arrays"));
class MultiDictionary {
    ...
    constructor(toStrFunction, valuesEqualsFunction, allowDuplicateValues = false) {
        this.dict = new Dictionary_1.Dictionary(toStrFunction);
...
exports.MultiDictionary = MultiDictionary;
